...
public class FavoriteFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LikesRef = FirebaseDatabase.getInstance().getReference().child("Likes").child(mAuth.getCurrentUser().getUid());
    ...
    public void onStart() {
        ...
        adapter = new FirebaseRecyclerAdapter<Posts, PostsVIewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull final PostsVIewHolder holder, final int position, @NonNull Posts model) {
                final String likerId = getRef(position).getKey();
                LikesRef.child(likerId).addValueEventListener(new ValueEventListener() {
                    @Override
...
//
//                                    intent.putExtra("postKey", likerId);
